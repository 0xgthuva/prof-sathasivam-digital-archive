...
<section class="sabbi-section stage_education_post stage_education_post-single">
    <div class="container">
        <div class="education_post_single-sagment">
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2">

                    <article id="post-<?php the_ID(); ?>" <?php post_class( 'sabbi-events-item sabbi-education-item' ); ?>>

                        <header class="education-single-header">
                        ...
                        <?php if ( has_post_thumbnail() ) : ?>
                            <figure class="sabbi-education-featured-image">
                                <?php
                                the_post_thumbnail(
                                    'full',
                                    array(
